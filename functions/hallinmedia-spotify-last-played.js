...
export default {
  ...
  async scheduled(event, env) {
    ...
    console.log(
      `Refresh Spotify access token fetch took ${endTime - startTime} ms`,
    );
    ...
    await env.SPOTIFYACCESSTOKEN.put(
      "spotifyAccessToken",
    ...
    console.log(
      `Save Spotify access token to KV took ${endTime - startTime} ms`,
    );
    ...
    const spotifyAccessToken = await env.SPOTIFYACCESSTOKEN.get(
      "spotifyAccessToken",
      {
        cacheTtl: 3600,
      },
